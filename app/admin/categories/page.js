        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-text-secondary">Organize content topics.</p>
                </div>
            ...
            <div className="bg-panel border border-border rounded-2xl p-12 flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-xl font-bold text-text-primary mb-2">No Categories Found</h3>
                <p className="text-text-secondary max-w-md mb-6">
                    Define categories to structure your blog posts and resources.
                </p>
            </div>
        </div>
    );
